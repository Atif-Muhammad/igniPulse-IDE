...
function TableDetail({ details }) {
  ...
  return (
    <div
      className={`w-full h-full border-2 p-1 rounded-lg overflow-hidden ${
        darkTheme
    ...
    >
      {/* Fixed Header */}
      <h2
        className={`text-md md:block hidden font-semibold text-center rounded-lg ${
          darkTheme ? "bg-gray-700" : "bg-gray-200"
        } px-1 py-3 sticky top-0 z-10`}
      >
        Available Tables
      </h2>
